...
from netgear_api import (  # noqa: F401 — re-exported: tests and callers use
    NetgearClient, _Stdin,  # the hotspot_watchdog namespace for these names
    REBOOT_NOT_POSTED, REBOOT_UNKNOWN, REBOOT_CONFIRMED)
