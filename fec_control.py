...
def reseed_runtime(rt, old_table, new_table, now):
    ...
    """
    ratio = level_to_ratio(rt.current_level, old_table or new_table)
    return FecRuntime(ratio_to_level(ratio, new_table), 0, now)
